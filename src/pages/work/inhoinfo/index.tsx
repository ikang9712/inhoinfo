              ...
              <div className="work-div">
                <div className="text-container">
                  <div className="text-block">
                    ...
                    <p>
                      The design of the current website is inspired by Studio of
                      Eric Van Holtz and his website,{' '}
              ...
              <div className="work-div">
                ...
                <div className="text-container">
                  <div className="text-block">
                    ...
                    <p>
                      Transition reverse its action from the current state when
                      user leaves the mouse &#40;for hover&#41; or the action
                      gets stopped, but animation does not. The displacement of
                      the header between page navigations and most hover effects
                      were implemented with transition for smooth user
                      experience.
                    </p>
                  </div>
                  ...
                  <div className="text-block">
                    ...
                    <p>
                      I used window scrollY property, but due to its performance
                      issue, it seems better to apply intersection observer API
                      or other alternative solutions such as GSAP scroll
                      trigger. &#40; But GSAP scroll trigger is not free..!&#41;
                    </p>
                    <p>
                      Also when user opens about section the scroll behavior
                      gets locked. I initially used body-scroll-lock for this,
                      but use tua-body-scroll-lock! it works the best for mobile
                      environment.
                    </p>
                  </div>
                </div>
              ...
              <div className="work-div">
                ...
                <div className="text-container">
                  ...
                  <div className="text-block">
                    ...
                    <p>
                      The hero section &#40;top of the page&#41; had rotating 3D
                      model, which was implemented with three.js. Users can
                      rotate and zoom with mouse action. In addition to Takuya
                      Matsuyama&apos;s original implementation, I added extra
                      features. Users can contact me via email by filling up the
                      form on the website. They can also download the pdf of my
                      resume through Amazon S3 bucket link.
                    </p>
                  </div>
                </div>
              </div>
